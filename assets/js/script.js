function redirectTo404() {
  window.location.href = "/404.html"; // Замените "/404.html" на путь к вашей странице 404.
}

// Проверяем статус ответа сервера при загрузке страницы.
document.addEventListener("DOMContentLoaded", function() {
  // Используем fetch API для выполнения асинхронного запроса к запрашиваемой странице.
